...
class Attention(nn.Module):
    ...
    def forward(
        ...
        **cross_attention_kwargs,
        ...
        return self.processor(
            self,
            hidden_states,# torch.Size([30, 256, 1280])
            encoder_hidden_states=encoder_hidden_states, # torch.Size([30, 77, 768])
...
class XFormersAttnProcessor:
    ...
    def __call__(
        ...
        **kwargs,
        ...
        residual = hidden_states #torch.Size([30, 256, 1280])
        ...
        batch_size, key_tokens, _ = (  #30 77 768
            hidden_states.shape if encoder_hidden_states is None else encoder_hidden_states.shape
        )
