...
class Transformer2DModel(ModelMixin, ConfigMixin):
    ...
    def __init__(
        ...
        self.attention_head_dim = attention_head_dim #1.40 ,2.80 3.160 循环两遍为1次  up:80 40
        inner_dim = num_attention_heads * attention_head_dim #320,640,1280 up:640 320

        # Define input layers
        self.in_channels = in_channels #320,640,1280 up:640 320
...
class BasicTransformerBlock(nn.Module):
    ...
    def __init__(
        ...
        self.use_ada_layer_norm = (num_embeds_ada_norm is not None) and norm_type == "ada_norm" #layer norm
        ...
        self.attn1 = Attention(
            query_dim=dim,#1.320 2.640 3.1280
        ...
        if cross_attention_dim is not None:
            self.attn2 = Attention(
                query_dim=dim,#1.320 2.640 3.1280  up: 640 320
...
class FeedForward(nn.Module):
    ...
    def __init__(
        ...
        super().__init__()
        inner_dim = int(dim * mult)#1280  2560 5120 #up 2560 1280
        dim_out = dim_out if dim_out is not None else dim #320  640 1280 up:640  320
...
class GEGLU(nn.Module):
    ...
    def __init__(self, dim_in: int, dim_out: int):   #3.in 1280 out 5120
        super().__init__()
